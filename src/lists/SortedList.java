...
public class SortedList extends DynamicList {
	...
	/**
	 * Inserts the specified elements in this list such that the list
	 * remains in sorted order (ascending by key).
	...
	/**
	 * Does a binary search to find the index of the element with specified key.  (Recursive
	 * implementation.)
	 * @param key the key of the element we are searching for.
	 * @param begin the start index of the segment of the array we're searching.
	 * @param end the last index (inclusive), of the segment of the array we're searching.
	...
	/**
	 * This overrides the getIndex implementation in DynamicList.
